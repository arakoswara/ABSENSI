...
<body>
    ...
    <ul id="nav-fast-menu">
    	<li>
    		<a href="admin.php?mod=siswa&act=addnew" class="themed-background-fire" data-toggle="tooltip" data-original-title="+ <?=$langmenu50;?>">
    			<i class="fa fa-book"></i>
    		</a>
    	</li>

        <li>
        	<a href="admin.php?mod=post&act=addnew" class="themed-background-fire" data-toggle="tooltip" data-original-title="+ <?=$langmenu2;?>"><i class="fa fa-book"></i></a>
        </li>
