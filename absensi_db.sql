...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2015 at 03:22 AM
...
INSERT INTO `absen` (`ida`, `id_siswa`, `kelas`, `tgl`, `ket`, `jam`) VALUES
(1, '2147483647', 12, '29-07-2015 07:56:36', 'H', 1),
(2, '2012470031', 12, '29-07-2015 07:56:36', 'H', 1),
(3, '2012470001', 12, '29-07-2015 07:56:36', 'H', 1),
(4, '2147483647', 12, '29-07-2015 07:56:54', 'H', 2),
(5, '2012470031', 12, '29-07-2015 07:56:54', 'H', 2),
(6, '2012470001', 12, '29-07-2015 07:56:54', 'I', 2),
(7, '9965340897', 10, '29-07-2015 08:09:52', 'H', 1),
(8, '9985108328', 10, '29-07-2015 08:09:52', 'H', 1),
(9, '9974601836', 10, '29-07-2015 08:09:52', 'H', 1),
(10, '9985108364', 10, '29-07-2015 08:09:52', 'H', 1),
(11, '9965309342', 10, '29-07-2015 08:09:52', 'H', 1),
(12, '9974601924', 10, '29-07-2015 08:09:52', 'H', 1),
(13, '9974601993', 10, '29-07-2015 08:09:52', 'H', 1),
(14, '9974602034', 10, '29-07-2015 08:09:52', 'H', 1),
(15, '9974602051', 10, '29-07-2015 08:09:52', 'H', 1),
(16, '9974602083', 10, '29-07-2015 08:09:52', 'H', 1);
...
`id_guru` int(10) NOT NULL COMMENT 'idg',
...
INSERT INTO `guru` (`id_guru`, `nip`, `nama`, `jk`, `alamat`, `idk`, `pass`) VALUES
...
(3, 'dkajkkjfa', '&lt;p&gt;ljkjdfkgajk&lt;/p&gt;', 'dkajkkjfa', '', 'Y'),
(4, 'dkajkkjfa', '&lt;p&gt;ljkjdfkgajk&lt;/p&gt;', 'dkajkkjfa', '', 'Y');
...
(1, 'sekolah', 'http://localhost/ALL PROJECT/ABSENSI', 'arakoswara2@gmail.com', 'sekolah', 'popojicms, website popojicms, cms indonesia, cms terbaik indonesia, cms gratis, cms gratis indonesia, alternatif cms', 'favicon.png', 'Asia/Jakarta', 'N', '', 'N', '', 'Y');
...
`id_siswa` int(10) NOT NULL,
  ...
  `p_ayah` varchar(50) NOT NULL COMMENT 'pekerjaan ayah',
  `ibu` varchar(50) NOT NULL,
  `p_ibu` varchar(50) NOT NULL COMMENT 'pekerjaan ibu',
  `pass` text NOT NULL
...
INSERT INTO `siswa` (`id_siswa`, `nis`, `nama`, `jk`, `alamat`, `idk`, `tlp`, `ayah`, `p_ayah`, `ibu`, `p_ibu`, `pass`) VALUES
(1, '9965340897', 'Agus Prayitno', 'L', '-', 10, '85733743907', '-', '-', '-', '-', 'bcd724d15cde8c47650fda962968f102'),
(2, '2147483647', 'KOSWARA', 'L', 'SUKABUMI', 12, '2147483647', 'DIDI', '-', 'HJ SHOLIHAT', 'IBU RUMAH TANGGA', 'KOSWARA'),
...
(18, '2012470031', 'ARA KOSWARA', 'L', 'SUKABUMI', 11, '089673287943', 'DIDI', '-', 'HJ JAMILAH', 'IBU RUMAH TANGGA', 'KOSWARA'),
(19, '2012470031', 'Saptaji', 'L', 'Kp. Cisayang Kulon', 12, '089673287943', 'Maman', 'Pedagang', 'Sinta', 'Ibu Rumah Tangga', 'ahong'),
(20, '2012470001', 'Sofyan', 'L', 'Kp. Cisayang', 12, '089675645452', '-', '-', '-', '-', 'sofyan'),
(21, '1212', 'julaiha', 'L', 'sdfasdf', 0, 'dfdf', 'sdfasd', 'faf', 'adfa', 'afdad', 'dfadf');
...
('::1', '2015-06-05', 2, '1433510314'),
('::1', '2015-06-06', 2, '1433591741'),
('::1', '2015-06-07', 3, '1433653488'),
('::1', '2015-06-15', 2, '1434347598'),
('::1', '2015-06-16', 18, '1434464272'),
('::1', '2015-06-22', 2, '1434980848'),
('::1', '2015-07-01', 1, '1435687933'),
('::1', '2015-07-09', 1, '1436413873'),
('::1', '2015-07-13', 1, '1436760259'),
('::1', '2015-07-15', 2, '1436932287'),
('::1', '2015-07-16', 1, '1436982703'),
('::1', '2015-07-20', 1, '1437399989'),
('::1', '2015-07-21', 1, '1437441545'),
('::1', '2015-07-22', 1, '1437505622'),
('::1', '2015-07-25', 44, '1437807974'),
('::1', '2015-07-28', 1, '1438051869'),
('::1', '2015-07-29', 2, '1438129266');
...
(1, 'admin', '0192023a7bbd73250516f069df18b500', 'Administrator', 'arakoswara2@gmail.com', '08xxxxxxxxxx', 'No matter how exciting or significant a person''s life is, a poorly written biography will make it seem like a snore. On the other hand, a good biographer can draw insight from an ordinary life-because they recognize that even the most exciting life is an ordinary life! After all, a biography isn''t supposed to be a collection of facts assembled in chronological order; it''s the biographer''s interpretation of how that life was different and important.', '', '1', 'N', 'jl8qo3kp7g6ouqhq6sm9igvih1', '2015-06-05', NULL, '0');
...
--
ALTER TABLE `absen`
MODIFY `ida` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
...
--
ALTER TABLE `guru`
MODIFY `id_guru` int(10) NOT NULL AUTO_INCREMENT COMMENT 'idg',AUTO_INCREMENT=25;
--
...
--
ALTER TABLE `user_role`
MODIFY `id_role` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=48;
